...
input_txt_path = r"E:\0aCrashedHP\0a_ResumePreparation2020\00a2024\pixxel\assignment\vfiles\gateway_engineer_assignment\images\out4.txt"
...
if (flag==1):
    width, height = 62, 62
    output_image_path = r"out7b_p62.png"
elif (flag==2):
    width, height = 61, 61 # needed when circuit was missing to create 4 pixels at output
    output_image_path = r"out7b_p61.png"
elif (flag==3):
    width, height = 31, 31
    output_image_path = r"E:\0aCrashedHP\0a_ResumePreparation2020\00a2024\pixxel\assignment\vfiles\gateway_engineer_assignment\images\out4_impl.png"
